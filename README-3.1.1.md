<a href="https://dot.net/architecture">
   <img src="https://github.com/dotnet-architecture/eShopOnContainers/raw/dev/img3.1.1/eshop_logo.png" alt="eShop logo" title="eShopOnContainers" align="right" height="60" />
</a>
...
![](img3.1.1/eshop-webmvc-app-screenshot.png)
...
![](img3.1.1/eshop_logo.png)
![](img3.1.1/eShopOnContainers-architecture.png)
...
| ------------ | ------------|  ------------|
| [![](img3.1.1/architecture-book-cover-large-we.png)](https://aka.ms/microservicesebook) | [![](img3.1.1/devops-book-cover-large-we.png)](https://aka.ms/dockerlifecycleebook) | [![](img3.1.1/xamarin-enterprise-patterns-ebook-cover-large-we.png)](https://aka.ms/xamarinpatternsebook) |
